...
const TimeSeriesProcessing = () => {
  const courseLinks = [
    ...
    //   component: lazy(() => import("pages/module10/course/Preprocessing")),
    //   subLinks: [
    ...
    //   component: lazy(() => import("pages/module10/course/Representation")),
    //   subLinks: [
    ...
    //   component: lazy(() => import("pages/module10/course/Seq2Seq")),
    //   subLinks: [
    ...
    //   component: lazy(() => import("pages/module10/course/Classification")),
    //   subLinks: [
    ...
    //   component: lazy(() => import("pages/module10/course/NER")),
    //   subLinks: [
    ...
    //   component: lazy(() => import("pages/module10/course/MachineTranslation")),
    //   subLinks: [
    ...
    //   component: lazy(() => import("pages/module10/course/TextGeneration")),
    //   subLinks: [
    ...
    //   component: lazy(() => import("pages/module10/course/QASystems")),
    //   subLinks: [
    ...
    //   component: lazy(() => import("pages/module10/course/Summarization")),
    //   subLinks: [
  ...
  return (
    <ModuleFrame
      module={9}
      isCourse={true}
      title="Module 9: Time Series Processing"
    ...
    >
      {location.pathname === `/module${module}/course` && (
        <>
          <Row>
            <p>
              This module covers advanced topics in TimeSeries
