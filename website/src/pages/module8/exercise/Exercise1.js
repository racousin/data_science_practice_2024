...
const Exercise1 = () => {
  const trainDataUrl =
    ...
    "/modules/module8/exercise/module8_exercise_train.csv";
  const testDataUrl =
    process.env.PUBLIC_URL +
    "/modules/module8/exercise/module8_exercise_test.csv";
  const notebookUrl =
    process.env.PUBLIC_URL + "/modules/module8/exercise/module8_exercise.ipynb";
  const notebookHtmlUrl =
    process.env.PUBLIC_URL + "/modules/module8/exercise/module8_exercise.html";
  const notebookColabUrl =
    process.env.PUBLIC_URL +
    "website/public/modules/module8/exercise/module8_exercise.ipynb";
  const metadata = {
    description:
        ...
        <Col>
          ...
          <ol>
            ...
            <li>
              ...
              <code>module8</code> directory under your username folder.
            </li>
            <li>
