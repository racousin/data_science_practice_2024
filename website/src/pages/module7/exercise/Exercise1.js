...
const Exercise1 = () => {
  const trainDataUrl =
    ...
    "/modules/module7/exercise/module7_exercise_train.csv";
  const testDataUrl =
    process.env.PUBLIC_URL +
    "/modules/module7/exercise/module7_exercise_test.csv";
  const notebookUrl =
    process.env.PUBLIC_URL + "/modules/module7/exercise/module7_exercise.ipynb";
  const notebookHtmlUrl =
    process.env.PUBLIC_URL + "/modules/module7/exercise/module7_exercise.html";
  const notebookColabUrl =
    process.env.PUBLIC_URL +
    "website/public/modules/module7/exercise/module7_exercise.ipynb";
  const metadata = {
    description:
        ...
        <Col>
          ...
          <ol>
            ...
            <li>
              ...
              <code>module7</code> directory under your username folder.
            </li>
            <li>
