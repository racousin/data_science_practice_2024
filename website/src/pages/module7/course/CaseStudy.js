...
const CaseStudy = () => {
  const trainDataUrl =
    process.env.PUBLIC_URL + "/modules/module7/course/module7_course_train.csv";
  const testDataUrl =
    process.env.PUBLIC_URL + "/modules/module7/course/module7_course_test.csv";
  const requirementsUrl =
    process.env.PUBLIC_URL + "/modules/module7/course/module7_requirements.txt";
  const notebookUrl =
    process.env.PUBLIC_URL + "/modules/module7/course/module7_course.ipynb";
  const notebookHtmlUrl =
    process.env.PUBLIC_URL + "/modules/module7/course/module7_course.html";
  const notebookColabUrl =
    process.env.PUBLIC_URL +
    "website/public/modules/module7/course/module7_course.ipynb";
  const metadata = {
    description:
