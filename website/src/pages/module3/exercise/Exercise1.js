...
const Exercise1 = () => {
  const trainDataUrl =
    ...
    "/modules/module3/exercise/module3_exercise_train.csv";
  const testDataUrl =
    process.env.PUBLIC_URL +
    "/modules/module3/exercise/module3_exercise_test.csv";
  const notebookUrl =
    process.env.PUBLIC_URL + "/modules/module3/exercise/module3_exercise.ipynb";
  const notebookHtmlUrl =
    process.env.PUBLIC_URL + "/modules/module3/exercise/module3_exercise.html";
  const notebookColabUrl =
    process.env.PUBLIC_URL +
    "website/public/modules/module3/exercise/module3_exercise.ipynb";
  const metadata = {
    description:
